  ...
  return (
    <>
      <div className="rounded shadow-xl overflow-hidden w-full md:flex" style={{ maxWidth: "900px" }}>
        <div className="flex w-full md:w-1/2 px-5 pb-1 pt-1 bg-indigo-500 text-white items-center">
          ...
          <div className="w-full">
            ...
            <div className="flex w-full items-end mb-6">
              ...
              <span className="block leading-5 text-sm ml-4 text-green-500">
                {`${info.price.high - info.price.low < 0 ? "▼" : "▲"} ${(info.price.high - info.price.low).toFixed(
                  3
                )} (${((info.price.high / info.price.low) * 100 - 100).toFixed(3)}%)`}
              </span>
            </div>
